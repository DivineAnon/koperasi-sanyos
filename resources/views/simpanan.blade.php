                ...
                <div class="nav-tabs-horizontal" data-plugin="tabs">
                    <ul class="nav nav-tabs nav-tabs" role="tablist">
                        <li class="nav-item" role="presentation"><a class="nav-link active show" data-toggle="tab"
                                ...
                                aria-selected="true">Master Simpanan</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab"
                                ...
                                aria-selected="false">Simpanan</a></li>
                        <li class="nav-item" role="presentation"><a class="nav-link" data-toggle="tab"
                                href="#exampleTabsSolidThree" aria-controls="exampleTabsSolidThree" role="tab"
                                aria-selected="false">Transaksi Simpanan</a></li>
                        <li class="dropdown nav-item" role="presentation" style="display: none;">
                            <a class="dropdown-toggle nav-link" data-toggle="dropdown" href="#"
                                aria-expanded="false">Dropdown </a>
                            <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" data-toggle="tab" href="#exampleTabsSolidOne"
                                    aria-controls="exampleTabsSolidOne" role="tab">Master Simpanan</a>
                                <a class="dropdown-item" data-toggle="tab" href="#exampleTabsSolidTwo"
                                    aria-controls="exampleTabsSolidTwo" role="tab">Simpanan</a>
                                <a class="dropdown-item" data-toggle="tab" href="#exampleTabsSolidThree"
                                    aria-controls="exampleTabsSolidThree" role="tab">Transaksi Simpanan</a>
                            </div>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active show" id="exampleTabsSolidOne" role="tabpanel">
                            <div class="panel mt-10">
                                <h2 class="text-center mt-10"><b>DATA MASTER SIMPANAN</b></h2>
                                <header class="panel-heading">
                                    <div class="panel-actions">
                                        <div class="dt-buttons btn-group">
                                            <a href="" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0"
                                                aria-controls="exampleTableTools" type="button"><span>Copy</span></a>
                                            <a href="" class="btn btn-secondary buttons-csv buttons-html5" tabindex="0"
                                                aria-controls="exampleTableTools" type="button"><span>CSV</span></a>
                                            <a href="" class="btn btn-secondary buttons-print" tabindex="0"
                                                aria-controls="exampleTableTools" type="button"><span>Print</span></a>
                                        </div>
                                    </div>
                                    <h3 class="panel-title">
                                        <a href="" class="btn btn-primary waves-effect waves-classic"
                                            style="color: aliceblue"><i class="icon md-plus"></i>Tambah Data</a>
                                    </h3>
                                </header>
                                    ...
                                    <table class="table table-hover dataTable table-striped w-full"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href=""
                                                        class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row waves-effect waves-classic"><i
                                                            class="icon md-edit"></i> Ubah</a>
                                                    <a href=""
                                                        class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row waves-effect waves-classic"><i
                                                            class="icon md-delete"></i> Hapus</a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="tab-pane" id="exampleTabsSolidTwo" role="tabpanel">
                            <div class="panel mt-10">
                                <h2 class="text-center mt-10"><b>DATA SIMPANAN</b></h2>
                                <header class="panel-heading">
                                    <div class="panel-actions">
                                        <div class="dt-buttons btn-group">
                                            <a href="" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0"
                        ...
                        <div class="tab-pane" id="exampleTabsSolidThree" role="tabpanel">
                            <div class="panel mt-10">
                                <h2 class="text-center mt-10"><b>DATA TRANSAKSI SIMPANAN</b></h2>
                                <header class="panel-heading">
                                    <div class="panel-actions">
                                        <div class="dt-buttons btn-group">
                                            <a href="" class="btn btn-secondary buttons-copy buttons-html5" tabindex="0"
